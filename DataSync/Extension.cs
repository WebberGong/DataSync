...
namespace DataSync
{
    public static class Extension
    {
        ...
        {
            var foreignKeyProps = Assistance.GetPropertiesHaveSpecifiedAttribute<TEntity, ForeignKeyAttribute>();
        ...
        {
            var props = Assistance.GetPropertiesHaveSpecifiedAttribute<TEntity, ColumnAttribute>();
            var result = true;
        ...
        public static void AssignTo<TEntity>(this TEntity a, TEntity b) where TEntity : BaseEntity
        {
            if (a == null || b == null)
                return;
            var props = Assistance.GetProperties<TEntity>();
            foreach (var prop in props)
